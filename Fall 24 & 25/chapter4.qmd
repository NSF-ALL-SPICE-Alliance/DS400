...
2.  Prior: π∼Beta(3,10), data: Y=10 successes in n=13 trials

```{r}
plot_beta_binomial(alpha = 3, beta = 10, y = 10, n = 13)
```

posterior is an equal compromise between the data and the prior
...
data has more influence on the posterior
